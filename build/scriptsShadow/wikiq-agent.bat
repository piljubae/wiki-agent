...
set CLASSPATH=%APP_HOME%\lib\wikiq-agent-1.0.0-all.jar

@rem Execute wikiq-agent
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WIKIQ_AGENT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%WIKIQ_AGENT_EXIT_CONSOLE%" exit 1
exit /b 1
