...
import io.github.veronikapj.wiki.search.tool.CodeFlowTool
import io.github.veronikapj.wiki.search.tool.PersonalDataTool
import io.github.veronikapj.wiki.search.tool.ProgressAdvisorTool
...
fun main() {
    ...
    // personalData.allowedUsers와는 별개 개념(서버 운영 권한)이므로 독립적으로 관리한다.
